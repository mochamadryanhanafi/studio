...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full h-[calc(100dvh-3.5rem)] min-h-[500px] flex items-center justify-center text-center overflow-hidden">
      <Hero3D />
      <div className="relative z-10 container px-4 sm:px-6 lg:px-8 flex flex-col items-center animate-in fade-in duration-1000 ease-out">
        <h1 className="font-headline text-4xl font-bold tracking-tight text-foreground sm:text-6xl md:text-7xl">
          {t('hero.title')}
        </h1>
        <p className="mt-6 max-w-2xl text-lg text-foreground/80 sm:text-xl delay-200">
          {t('hero.subtitle')}
        </p>
